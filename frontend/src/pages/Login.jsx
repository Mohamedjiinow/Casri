...
const Login = () => {
    ...
    // Token iyo xogta kale ee Context-ga laga soo qaatay
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (data.success) {
                // Kaydi Token-ka iyo Xogta User-ka ee LocalStorage
                localStorage.setItem('token', data.token)
                localStorage.setItem('user', JSON.stringify(data.user))
                
                // Ku cusboonaysii Context-ga
                setToken(data.token)
        ...
        <div className="min-h-screen flex items-center justify-center bg-[#f0f4f8] p-4 font-sans overflow-hidden relative">
            ...
            <div className="w-full max-w-md z-10">
                ...
                <div className="text-center mb-8">
                    <div className="inline-flex items-center justify-center w-20 h-20 bg-white rounded-[2rem] shadow-xl shadow-blue-100 mb-4 transform hover:rotate-12 transition-transform duration-300">
                        <ShieldCheck size={40} className="text-blue-600" />
                    </div>
                    <h1 className="text-3xl font-black text-slate-800 tracking-tight uppercase italic">Smart<span className="text-blue-600 font-black">School</span></h1>
                    <p className="text-slate-500 font-bold text-xs uppercase tracking-[0.2em] mt-2">Management System v2.0</p>
                </div>
